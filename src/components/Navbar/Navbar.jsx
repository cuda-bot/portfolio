  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled
          ? "bg-[#18122B]/50 backdrop-blur-lg shadow-md border border-white/10"
          : "bg-transparent"
        }`}
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Archit</span>
          <span className="text-[#8245ec]">/</span>
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/cuda-bot"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/archit-rajput-268828322/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
          ...
          <a
            href="https://leetcode.com/u/archit_rajput/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
